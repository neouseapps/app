  ...
  return (
    <div className="bg-section-bg text-slate-800 flex flex-col min-h-screen font-sans">
      ...
      {/* ================================================================
          7. FOOTER
      ================================================================ */}
      <footer className="bg-slate-900 pt-16 pb-8 border-t border-slate-800 text-slate-400 mt-auto">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-slate-800 text-white rounded flex items-center justify-center font-serif font-bold text-sm">
                V
              </div>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-accent-red transition-colors"
              >
                <FacebookIcon />
              </a>
              <a
          ...
          <div className="text-center text-xs border-t border-slate-800 pt-8">
            <p>© 2024 Visit Vietnam Asia. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
